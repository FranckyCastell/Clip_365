...
_Este proyecto consiste en la creación de una Web para una un seguimiento de donde podemos llegar vendiendo un Clip._
...
```
git clone https://github.com/FranckyCastell/Clip_365.git
```
